...
impl Weekday {
    // Helper method để convert Weekday thành index của array
...
impl WeekTemperatures {
    pub fn new() -> Self {
        WeekTemperatures {
            temperatures: [None; 7], // Khởi tạo tất cả 7 ngày với None
        }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        let index: usize = day.to_index();
        self.temperatures[index]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        let index = day.to_index();
